...
from reproof.repair_android_signing import AndroidSigningMaterialResolver
...
class ProtectedServiceMaterialTests(unittest.TestCase):
    ...
    def bind(self,body=None):
        from reproof.protected_service_materials import bind_service_materials
    ...
    def test_profile_binding_duplicates_and_extra_commands_are_rejected_before_registration(self):
        from reproof.protected_service_materials import ProtectedServiceMaterialsError
    ...
    def test_failure_after_partial_registration_closes_and_erases_created_registries(self):
        from reproof import protected_service_materials as materials
        created=[]
    ...
    def test_duplicate_json_keys_and_oversized_input_are_rejected_and_buffer_cleared(self):
        from reproof.protected_service_materials import ProtectedServiceMaterialsError, MAX_MATERIAL_INPUT_BYTES
    ...
    def test_bounded_stream_reader_uses_no_environment_or_secret_file_discovery(self):
        from reproof.protected_service_materials import read_service_materials, MAX_MATERIAL_INPUT_BYTES
    ...
    def test_material_stream_connects_to_the_current_qualified_service_chain(self):
        from reproof.protected_service_materials import compose_service_from_material_stream
    ...
    def test_unqualified_start_does_not_consume_the_secret_stream(self):
        from reproof.protected_service_materials import compose_service_from_material_stream,ProtectedServiceMaterialsError
        stream=io.BytesIO(bytes(self.body()))
