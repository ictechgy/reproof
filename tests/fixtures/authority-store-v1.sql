-- Frozen authority journal schema v1, before recovered dispositions.
            ...
            CREATE TABLE operations (
                ...
                status TEXT NOT NULL CHECK (status IN ('queued', 'uncertain', 'succeeded', 'rejected', 'expired')),
            ...
            CREATE TABLE reconciliation_dispositions (
                ...
                operation_id TEXT NOT NULL REFERENCES operations(operation_id),
                terminal_status TEXT NOT NULL CHECK (terminal_status IN ('not-dispatched', 'succeeded', 'rejected')),
                result_digest TEXT NOT NULL,
...
INSERT INTO authority_metadata VALUES ('format_version', '1'), ('minimum_reader_version', '1'), ('minimum_writer_version', '1');
