...
enum RLAutoConfig {
    static let profileJSON = #"{"schemaVersion":1,"kind":"uikit-runtime-v1","applicationId":"io.reproof.sample.ios","project":"Reproof.xcodeproj","target":"ReproSample","cases":["counter","duplicate-submit","reset"],"textTargets":["counter.name"],"numericTargets":["counter.count"],"tapTargets":["counter.add","counter.next","counter.reset"],"backTarget":"counter.back","screenTargets":{"counter.screen.main":"main","counter.screen.details":"details"},"startState":{"screen":"main","nodes":{"counter.name":"","counter.count":"0"}}}"#
