...
class RunStore:
    ...
    def finish_mobile_recovery(self, capability, *, authority):
        ...
        if (type(authority) is not AndroidOperationStore or type(capability) is not AndroidCleanupCapability
                or authority.run_store is not self):
        ...
        try:
            with self._control():
                ...
                if authority.require_cleanup(capability, self) is not capability:
                    raise RunDenied("Mobile cleanup authority is unavailable")
                parent = open_directory(self.root / "runs")
                try:
                    ...
                    os.fsync(parent)
                run = OwnedRun(self, capability.operation_id, capability.request_digest)
    ...
    def finish_ios_native_recovery(self, capability, *, authority):
        ...
        if (type(authority) is not IOSMobileOperationStore or authority.run_store is not self
        ...
        try:
            ...
            with self._control():
                ...
                session = require_ios_recovery_cleanup(authority, capability, self)
    ...
    def finish_ios_preparation_recovery(self, capability, *, authority):
        ...
        try:
            ...
            with self._control():
                ...
                session = authority.require_preparation_cleanup(capability,self)
    ...
    def consume_ios_native_disposal(self, native_owner, cleanup_token, sanitation, evidence_digest,
        ...
        try:
            require(type(native_owner) is IOSMobileNativeOwner and native_owner.operations.run_store is self,
            ...
            with self._control():
                value=self._load();record=value['runs'].get(context.operation_id)
    ...
    def finish_signing_recovery(self, capability, *, authority):
        ...
        try:
            ...
            with self._control():
                ...
                accepted = authority.require_cleanup(capability, self)
